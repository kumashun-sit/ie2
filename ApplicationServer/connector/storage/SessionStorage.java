...
public class SessionStorage {
    ...
    public Session get(String userID) throws IllegalArgumentException{
    ...
    public String get(Session session) throws IllegalArgumentException{
